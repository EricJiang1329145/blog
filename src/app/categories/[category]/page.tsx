    ...
    <div className="max-w-4xl mx-auto">
      ...
      <div className="mb-16 text-center">
        <h1 className="text-4xl font-bold mb-4">
          ...
          <span className="neon-text-purple">{category}</span>
        </h1>
      ...
      <div className="space-y-8">
        {posts.length === 0 ? (
          <div className="text-center py-16">
            <p className="text-foreground/70 text-xl">该分类下暂无文章</p>
          </div>
        ) : (
          posts.map((post) => (
      ...
      <div className="mt-12 text-center">
        <Link href="/categories" className="inline-flex items-center gap-2 text-neon-green hover:neon-text-green transition-all">
